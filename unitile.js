...
// fs.mkdir("lolu", function(err){
//   if(err) console.log(err);
//   else console.log("created a folder");
  
  
// })


// fs.readdir("lolu", {withFileTypes: true}, function(err,files){
//   if(err) console.log(err);
...
fs.rm("lolu", {recursive:true}, function(err){
  if(err) console.log(err);
